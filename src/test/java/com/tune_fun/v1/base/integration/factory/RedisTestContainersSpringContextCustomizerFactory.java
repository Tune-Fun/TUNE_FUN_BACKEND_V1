...
import com.tune_fun.v1.base.integration.EmbeddedRedis;
    ...
    public ContextCustomizer createContextCustomizer(Class<?> testClass, List<ContextConfigurationAttributes> configAttributes) {
        return (context, mergedConfig) -> {
            ...
            if (null != redisAnnotation) {
                ...
                testValues = testValues.and("spring.data.redis.host=" + redisBean.getRedisContainer().getHost());
                testValues = testValues.and("spring.data.redis.port=" + redisBean.getRedisContainer().getMappedPort(6379));
            }
