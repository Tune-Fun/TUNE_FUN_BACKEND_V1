...
public class PostgreSqlTestContainer implements SqlTestContainer {
    ...
    @Override
    public void destroy() {
        if (null != postgreSQLContainer && postgreSQLContainer.isRunning()) postgreSQLContainer.stop();
    }

    @Override
    public void afterPropertiesSet() {
        if (null == postgreSQLContainer) postgreSQLContainer = new PostgreSQLContainer<>("postgres:16.2")
