...
public class KafkaTestContainersSpringContextCustomizerFactory implements ContextCustomizerFactory {
    ...
    private final Logger log = LoggerFactory.getLogger(KafkaTestContainersSpringContextCustomizerFactory.class);
    ...
    public ContextCustomizer createContextCustomizer(Class<?> testClass, List<ContextConfigurationAttributes> configAttributes) {
        return (context, mergedConfig) -> {
            ...
            if (null != kafkaAnnotation) {
                ...
                testValues = testValues.and("spring.kafka.bootstrap-servers=" + kafkaBean.getKafkaContainer().getBootstrapServers());
            }
